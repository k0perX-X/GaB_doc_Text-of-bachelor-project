...
Следующим этапом будет описано тестирование модулей с использованием автоматизированного тестирования, а также ручного тестирования в соответствии с критериями белого и чёрного ящика, определение оценки количества ошибок в программе и оценки количества необходимых тестов [@plaksin, с. 18-26, с. 71-83].
