...
Из вышесказанного можно сделать вывод, что реализация бизнес-модели стартапа без использования автоматизированной цифровой программно-аппаратной системы учета аренды нецелесообразна, так как услуга предоставляемая по такой бизнес-модели стоила бы слишком дорого, что значительно уменьшило бы спрос, что сделало бы компанию убыточной. 
